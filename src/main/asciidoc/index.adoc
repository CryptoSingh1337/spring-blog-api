...
TIP: Do you want to improve this page? Please https://github.com/CryptoSingh1337/spring-blog-api/edit/master/src/main/asciidoc/index.adoc[edit it on GitHub]
...
IMPORTANT: You can ignore all the null fields in request body,
only send those properties which are not null.
...
IMPORTANT: You can ignore all the null fields in request body,
only send those properties which are not null. Only title and body of
the post are going to update.
